...
# Paypal Valid Checker 2018
# 17 June 2K18
# By YassineHd='\033[0;31m'
CYAN='\033[0;36m'
YELLOW='\033[1;33m'
ORANGE='\033[0;33m' 
PUR='\033[0;35m'
...
cat <<EOF
             -**** YassineHd **** -
          [+] yassinexhd@gmail.com [+]
        
---------------------------------------------------
   Paypal Valid email checker 2018
---------------------------------------------------
...
malhadi_appleval() {
  ...
  footer="[Slackercode - PaypalValid 2018] $(($duration % 60))sec.\n"
...
echo "+==========+ Slackerc0de Family - PaypalValid 2018 - Malhadi Jr +==========+"